;;; my-doom-dark+-theme.el --- inspired by dark+ Theme by equinusocio -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup my-doom-dark+-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom my-doom-dark+-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'my-doom-dark+-theme
  :type '(choice integer boolean))

;;(defcustom my-doom-dark+-blue-modeline nil
...
(def-doom-theme my-doom-dark+
  ...
  ((bg         '("#000100" nil       nil))
   ...
   (-modeline-pad
    (when my-doom-dark+-padded-modeline
      (if (integerp my-doom-dark+-padded-modeline) my-doom-dark+-padded-modeline 4))))
